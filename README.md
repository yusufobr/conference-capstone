...
# 📖 Ex-Investor Event <a name="about-project"></a>
...
- **[The home page]**
- **[The about page]**
- **[Responsive for all screens sizes]**
- **[Hamburger Menu Aimation]**
...
```sh
  cd my-folder
  git clone git@github.com:yusufobr/conferance-capstone
```
...
Thanks to the Original design idea by : <a src="https://www.behance.net/adagio07"> Cindy Shin in Behance</a>. for giving me they opportunity to build this beutiful project.
